...
describe('对齐方式', () => {
	...
	it('实现内容居中对齐', () => {
		...
		cy.get('@droplist').find('.w-e-list').children().should('have.length', 4).eq(1).contains('居中')
	...
	it('实现内容左对齐', () => {
		...
		cy.get('@droplist').find('.w-e-list').children().should('have.length', 4).eq(0).contains('靠左')
	...
	it('实现内容右对齐', () => {
		...
		cy.get('@droplist').find('.w-e-list').children().should('have.length', 4).eq(2).contains('靠右')
	...
	it('实现内容两端对齐', () => {
		...
		cy.get('@droplist').find('.w-e-list').children().should('have.length', 4).eq(3).contains('两端')
